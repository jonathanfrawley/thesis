...
%%
  \include{intro}
  \include{backgroundwebgl}
  \include{backgroundpcg}
  \include{design}
...
%\bibliographystyle{dcu}                               %% also use the \bibliography command
%\bibliographystyle{acmtog}                               %% also use the \bibliography command
\bibliographystyle{ieeetr}                               %% also use the \bibliography command
